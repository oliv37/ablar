...
export default function GeoMapFraDpt({ className }: Props) {
  return (
    <svg
      ...
      className={className}
    >
      <g className="fill-none stroke-foreground stroke-2">
        <path id="corsica_separating_line" d="M783 1e3v-130l119-78" />
      </g>
      <g className="fill-background stroke-foreground stroke-2">
        <path
          id="2A"
